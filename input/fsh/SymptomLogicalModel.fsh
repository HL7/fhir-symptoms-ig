...
* affectedPatient 1..1 Patient ""
* recorder[x] 1..1 Patient or RelatedPerson or PractitionerRole or Organization ""
* symptomDescription 0..* Annotation "Textual description of symptom as provided by care team member"

* keyFeatures 0..* BackboneElement "Key Features" "The key features of the symptom"
* keyFeatures.location 0..* BodyStructure "Where the patient feels the symptom in the body."
* keyFeatures.quality 0..1 BackboneElement "The patient's internal perception of the symptom." 
* keyFeatures.quality.note 0..1 Annotation "Free text related to the observation" 
...
* keyFeatures.severity.note 0..1 Annotation "Free text related to the observation" 
