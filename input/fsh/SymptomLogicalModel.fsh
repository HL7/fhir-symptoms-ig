...
* keyFeatures.triggers.value 1..1 "Code or string describing the specific event." ""
...
* keyFeatures.riskFactor.value 1..1 "" ""
...
* timing.onset.effective 0..1 dateTime "Clinically relevant time or period for the symptom" ""
...
* timing.onset.timing.value 1..1 "Date/time, period, or quantity describing the timing." ""  
