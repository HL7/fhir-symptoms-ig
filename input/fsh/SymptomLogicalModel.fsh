...
* inputs.text 0..1 Annotation "Patient or caregiver description of symptom"
...
* keyFeatures.triggers.note 0..* Annotation "Free text related to the observation"
...
* keyFeatures.alleviatingFactors.note 0..1 Annotation "Information given about actions, conditions, events, or other factors"
